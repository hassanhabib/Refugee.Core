...
namespace RefugeeLand.Core.Api.Migrations
{
    ...
    [Migration("20220713153736_UpdateRefugeeGroupMembershipFields")]
    partial class UpdateRefugeeGroupMembershipFields
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RefugeeLand.Core.Api.Models.ShelterRequests.ShelterRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("RefugeeApplicantId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("RefugeeGroupId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ShelterOfferId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("RefugeeApplicantId");

                    b.HasIndex("RefugeeGroupId");

                    b.HasIndex("ShelterOfferId");
            ...
            modelBuilder.Entity("RefugeeLand.Core.Api.Models.ShelterRequests.ShelterRequest", b =>
                {
                    b.HasOne("RefugeeLand.Core.Api.Models.Refugees.Refugee", "RefugeeApplicant")
                        .WithMany("ShelterRequests")
                        .HasForeignKey("RefugeeApplicantId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.HasOne("RefugeeLand.Core.Api.Models.ShelterOffers.ShelterOffer", "ShelterOffer")
                        .WithMany("ShelterRequests")
                        .HasForeignKey("ShelterOfferId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("RefugeeApplicant");

                    b.Navigation("RefugeeGroup");

                    b.Navigation("ShelterOffer");
                });
